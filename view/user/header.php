...
<head>
    ...
    <!-- <link rel="stylesheet" href="../../assets/css/datapengaduanadmin.css"> -->
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #1d3557;">
            ...
            <hr class="sidebar-divider my-0">
                ...
                <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link active" href="../user/dashboarduser.php">
                    <i class="fas fa-fw fa-house-user"></i>
                    <span>Dashboard</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../user/datapengaduanuser.php">
                    <i class="fas fa-fw fa-database"></i>
                    <span>Data Pengaduan</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../user/datapenggunauser.php">
          ...
          <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../../loginpage.php">Login</a>
